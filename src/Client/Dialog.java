...
public class Dialog extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(text != null && !text.isEmpty()){
            try {
                user.sendMessage(new Message(user.name, reciver, text));
            } catch (IOException ex) {
                Logger.getLogger(Dialog.class.getName()).log(Level.SEVERE, null, ex);
            }
            jTextArea1.append(user.name + ":\n" + text + "\n");
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    protected void Recive(Message message) {
        String str1 = message.getName();
        String str2 = message.getText();
        jTextArea1.append(str1 + ":\n" + str2 + "\n");
    } 
    
    protected void setReciver(String reciver){this.reciver = reciver;}
